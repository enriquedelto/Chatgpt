...
q1 = "Haz una pregunta para comenzar un debate entre un Capitalista y un Comunista.";
}

// Send the response to the second chat
c2t.value = "Como Capitalista responda lo siguiente tratando de dar datos y ejemplos que refuerzen el punto en cuestión y luego haga una pregunta al Comunista que dijo lo siguiente." + q1;
c2b.click();
...
setTimeout(() => chat("Como Comunista responda lo siguiente tratando de dar datos y ejemplos que refuerzen el punto en cuestión y luego haga una pregunta al Capitalista que dijo lo siguiente." + q2), 5000);
}

// Start the chat with the first message
chat("Haz una pregunta para comenzar un debate entre un capitalista y un comunista.");
